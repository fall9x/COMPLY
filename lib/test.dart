...
class _FlutterFactsDialogFlowState extends State<FlutterFactsDialogFlow> {
    ...
    void _dialogFlowResponse(query) async {
        ...
        await AuthGoogle(fileJson: "assets/comply-267617-1ca8cca5139f.json").build();
...
class test{
    ...
    List<String> take = ['Am I Bankrupt?', 'two', 'three'];
    List<String> give = ['Bankruptcy proceedings are commenced by way of the filing of a Bankruptcy Application to the High Court. A Bankruptcy Application can be filed by the debtor himself or a creditor who is owed not less than S$15,000.00 by a debtor.',
        'two', 'three'];
    Function eq = const ListEquality().equals;
    for (var i=0; i < 3 ; i++) {
        if (this.query == take[i]) {
